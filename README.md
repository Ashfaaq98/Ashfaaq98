...
|---------|------|-------------|------------|
| 💡 [Upcoming Projects](https://ashfaaq98.github.io/projects/upcoming-projects/) | Feb 2026 | A living roadmap of projects currently being explored and scoped | — |
| 🎯 [Technique Inference Engine (TIE)](https://ashfaaq98.github.io/projects/tie/) | Feb 2026 | Predicts MITRE ATT&CK® techniques from observed adversary behavior using WALS matrix factorization | `Python` `ML` `MITRE ATT&CK` |
| 🛡️ [MITRE ATT&CK Python Toolkit](https://ashfaaq98.github.io/projects/mitre-python/) | Dec 2025 | Comprehensive collection of Python scripts simulating MITRE ATT&CK techniques for security testing & research | `Python` `MITRE ATT&CK` |
| 🌳 [Stammbaum](https://ashfaaq98.github.io/projects/stammbaum/) | Nov 2025 | Desktop genealogy application | `JavaScript` `Electron` `HTML` `CSS` |
| 📦 [Aegis Forensics](https://ashfaaq98.github.io/projects/aegis-forensics/) | Nov 2025 | AI-powered digital forensics agent running in a secure disposable cloud sandbox | `MCP` `Groq` `E2B` `Docker` |
| 🥷 [AI Security Repo](https://ashfaaq98.github.io/projects/ai-sec-research/) | Oct 2025 | Curated collection of resources related to AI Security | — |
| 🖥️ [Console IR](https://ashfaaq98.github.io/projects/console-ir/) | Oct 2025 | Terminal-first incident response console for real-time OCSF event ingestion, enrichment & AI-assisted case management | `Go` `Redis` `SQLite` `Docker` |
| 🗃️ [GenAI Cyber Security Repo](https://ashfaaq98.github.io/projects/gen-ai-cyber/) | May 2025 | Curated collection of LLM-based resources for cyber security | — |
| 📈 [Skills Tracker](https://ashfaaq98.github.io/projects/skills-tracker/) | Apr 2025 | Application to track skills and progress toward goals | `Python` `Flask` `SQLite` `React` |
| 🧩 [MCP Servers for Cyber](https://ashfaaq98.github.io/projects/mcp-open-source/) | Apr 2025 | LangGraph CTI agent leveraging an MCP client to connect to cyber threat intel servers | `Python` `LangGraph` `MCP` `VirusTotal` |
| 🕷️ [Neural Malware Detector](https://ashfaaq98.github.io/projects/neural-malware-detector/) | Sep 2024 | Flask web app using Random Forest & RNN models to detect malware in uploaded files | `Python` `Flask` `scikit-learn` `TensorFlow` `Docker` |
| 🔭 [Periscope](https://ashfaaq98.github.io/projects/periscope/) | Jan 2024 | AI-enabled system for efficient cyber incident detection & response in cloud environments | `Python` `Docker` `TensorFlow` `Scapy` `GCP` `Azure` |
| 🫆 [Porsha](https://ashfaaq98.github.io/projects/porsha/) | Apr 2023 | Python-based digital forensics toolkit | `Python` `PyQt6` `pytsk3` `Scapy` `Hachoir` |
| 🌐 [SDN Load Balancer](https://ashfaaq98.github.io/projects/sdn/) | Jan 2022 | SDN-based load balancing algorithm using server bandwidth metrics on a POX controller | `Python` `SDN` `OpenFlow` `Mininet` `Raspberry Pi` |
| 🖧 [Enterprise Network Design](https://ashfaaq98.github.io/projects/enteprise-network-design/) | Nov 2021 | Comprehensive multi-tenant data center design focusing on HA and disaster recovery | `VMware NSX` `AWS` `vSphere ESXi` |
| 🌡️ [Autonomous Air Controller](https://ashfaaq98.github.io/projects/autonomous-air-controller/) | Oct 2020 | IoT system to autonomously control AC settings by monitoring room occupancy and temperature | `Python` `Raspberry Pi` `Arduino` `OpenCV` `AWS DynamoDB` |
| 🤖 [Line Following Robot](https://ashfaaq98.github.io/projects/line-following-robot/) | May 2019 | Arduino-based robot programmed in assembly to autonomously follow a black line path | `AVR Assembly` `Arduino` |
